...
"""
1.3 Flux Functions
Implement two Riemann solvers: Roe and one of your choice (e.g. HLLE, HLLC, Osher, ﬂux vector
splitting, etc. – see Riemann Solvers and Numerical Methods for Fluid Dynamics by E. F. Toro).
For the Roe ﬂux, use an entropy ﬁx with \epsilon = 0.1c.
"""
